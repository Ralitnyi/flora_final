...
5. У розділі **Environment Variables** додайте такі змінні:
   ...
   - `NODE_ENV` — `production`
6. Натисніть **Deploy Web Service**. Після завершення білду ваш бекенд буде доступний за адресою https://flora-backend-g2z3.onrender.com.

---

## Swagger Документація API
Після запуску сервера інтерактивна документація Swagger доступна за адресою:
`http://localhost:3001/api-docs` (локально) або `https://flora-backend-g2z3.onrender.com/api-docs` (на продакшені).
